 ...
 *
 */
final class DataSqlQuoteDouble01 extends AbstractData {

   /**
    *
    */
   DataSqlQuoteDouble01() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start double quote");
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addFirstAndLast(ConfigurationSql.ANNOTATION_QUOTE_DOUBLE, 0, 1, 4);
   }
