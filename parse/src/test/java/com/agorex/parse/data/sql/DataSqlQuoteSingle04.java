...
final class DataSqlQuoteSingle04 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("Start single, start double, close single quote");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(7, 8, ConfigurationSql.ANNOTATION_QUOTE_SINGLE);
      ...
      dataToken.add(24, 25, ConfigurationSql.ANNOTATION_QUOTE_SINGLE);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      dataAllAnnotation.setAnnotation(ConfigurationSql.ANNOTATION_QUOTE_SINGLE);
      dataAllAnnotation.addFirst(ConfigurationSql.ANNOTATION_QUOTE_SINGLE, 0, 1);
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_QUOTE_SINGLE, 5, 6);
   }
   ...
   protected void loadAllLandmarkForward(final DataAllLandmarkForward dataAllLandmark) {
      ...
      dataAllLandmark.addFirstAndLast("select".toCharArray(), 0, 6);
   }
   ...
   protected void loadAllLandmarkRange(final DataAllLandmarkRange dataAllLandmarkRange) {
      ...
      dataAllLandmarkRange.addFirstAndLast("select".toCharArray(), 0, 0, 6);
   }
}
