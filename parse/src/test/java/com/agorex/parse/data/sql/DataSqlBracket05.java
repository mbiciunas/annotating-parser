...
final class DataSqlBracket05 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("Open bracket within brackets");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(24, 25, ConfigurationSql.ANNOTATION_BRACKET_OPEN);
      dataToken.add(25, 33, ConfigurationSql.ANNOTATION_NONE);
      dataToken.add(33, 34, ConfigurationSql.ANNOTATION_BRACKET_CLOSE);
   }
   ...
   protected void loadAnnotationState(final DataAnnotationState dataAnnotationState) {
      ...
      dataAnnotationState.setBracketStart(5);
      dataAnnotationState.setBracketEnd(5);
   }
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_BRACKET_OPEN, 4, 6);
   }
