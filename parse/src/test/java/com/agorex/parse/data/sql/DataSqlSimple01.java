...
final class DataSqlSimple01 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("No Quotes or Brackets");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(7, 17, ConfigurationSql.ANNOTATION_NONE);
      dataToken.add(18, 22, ConfigurationSql.ANNOTATION_NONE);
      dataToken.add(23, 31, ConfigurationSql.ANNOTATION_NONE);
   }
   ...
   @Override
   protected void loadAllLandmarkForward(final DataAllLandmarkForward dataAllLandmarkForward) {
