...
final class DataSqlQuoteSingle01 extends AbstractData {

   DataSqlQuoteSingle01() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start single quote");
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addFirstAndLast(ConfigurationSql.ANNOTATION_QUOTE_SINGLE, 0, 1, 4);
   }
