...
final class DataSqlBracket09 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("Close then open bracket");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(7, 8, ConfigurationSql.ANNOTATION_BRACKET_CLOSE);
   ...
   protected void loadAnnotationState(final DataAnnotationState dataAnnotationState) {
      ...
      dataAnnotationState.setBracketState(BracketState.ERROR);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addFirstAndLast(ConfigurationSql.ANNOTATION_BRACKET_OPEN, 0, 3, 5);
   }
