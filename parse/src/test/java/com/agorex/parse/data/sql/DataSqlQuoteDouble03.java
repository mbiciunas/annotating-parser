...
final class DataSqlQuoteDouble03 extends AbstractData {

   DataSqlQuoteDouble03() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start double then start single quote");
   ...
   protected void loadAnnotationState(final DataAnnotationState dataAnnotationState) {
      dataAnnotationState.setQuoteState(QuoteState.DOUBLE);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addFirstAndLast(ConfigurationSql.ANNOTATION_QUOTE_DOUBLE, 0, 1, 5);
   }
