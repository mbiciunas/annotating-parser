 ...
 *
 */
final class DataSqlBracket04 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("Open then close a second bracket");
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_BRACKET_OPEN, 5, 7);
   }
   ...
   protected void loadAllLandmarkForward(final DataAllLandmarkForward dataAllLandmark) {
      ...
      dataAllLandmark.addLast("from".toCharArray(), 4, 7);
   }
   ...
   protected void loadAllLandmarkRange(final DataAllLandmarkRange dataAllLandmarkRange) {
      ...
      dataAllLandmarkRange.addLast("from".toCharArray(), 4, 7);
   }
}
