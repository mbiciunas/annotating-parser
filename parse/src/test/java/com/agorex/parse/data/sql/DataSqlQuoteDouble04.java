...
final class DataSqlQuoteDouble04 extends AbstractData {

   DataSqlQuoteDouble04() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start double, start single, close double quote");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(24, 25, ConfigurationSql.ANNOTATION_QUOTE_DOUBLE);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_QUOTE_DOUBLE, 5, 6);
   }
