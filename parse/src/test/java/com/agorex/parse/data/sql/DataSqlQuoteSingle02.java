 ...
 *
 */
final class DataSqlQuoteSingle02 extends AbstractData {

   /**
    *
    */
   DataSqlQuoteSingle02() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start and end single quote");
   ...
   protected void loadToken(final DataToken dataToken) {
      ...
      dataToken.add(18, 19, ConfigurationSql.ANNOTATION_QUOTE_SINGLE);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_QUOTE_SINGLE, 3, 5);
   }
