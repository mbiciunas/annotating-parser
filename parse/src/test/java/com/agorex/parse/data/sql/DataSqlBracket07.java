...
final class DataSqlBracket07 extends AbstractData {
   ...
   public Data makeData() {
      ...
      data.setDescription("Open two brackets");
   ...
   protected void loadAnnotationState(final DataAnnotationState dataAnnotationState) {
      ...
      dataAnnotationState.setBracketDepth(2);
      dataAnnotationState.setBracketStart(4);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addLast(ConfigurationSql.ANNOTATION_BRACKET_OPEN, 3, 5);
   }
