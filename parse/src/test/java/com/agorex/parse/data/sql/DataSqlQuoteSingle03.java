...
final class DataSqlQuoteSingle03 extends AbstractData {

   DataSqlQuoteSingle03() {
      super();
   }
   ...
   public Data makeData() {
      ...
      data.setDescription("Start single then start double quote");
   ...
   protected void loadAnnotationState(final DataAnnotationState dataAnnotationState) {
      dataAnnotationState.setQuoteState(QuoteState.SINGLE);
   ...
   protected void loadAllAnnotation(final DataAllAnnotation dataAllAnnotation) {
      ...
      dataAllAnnotation.addFirstAndLast(ConfigurationSql.ANNOTATION_QUOTE_SINGLE, 0, 1, 5);
   }
